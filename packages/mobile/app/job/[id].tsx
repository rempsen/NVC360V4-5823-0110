...
import { C, R, money, fmtDate, assetUrl } from "../../lib/theme";
...
const s = StyleSheet.create({
  ...
  saveNoteBtn: { backgroundColor: "#f59e0b", borderRadius: R.control, paddingVertical: 11, paddingHorizontal: 20, alignItems: "center" },
  ...
  sendBtn: { width: 44, height: 44, borderRadius: R.control, backgroundColor: C.brand, alignItems: "center", justifyContent: "center" },
  footer: {
    position: "absolute",
    left: 0,
    right: 0,
